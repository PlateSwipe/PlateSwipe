...
class RecipeOverviewTest {
  ...
  fun testIngredientAndInstructionSwitch() {
    ...
    composeTestRule.onNodeWithTag("instructionsView", useUnmergedTree = true).assertIsDisplayed()
  }
  ...
  fun testServingsCountButtons() {
    ...
    composeTestRule.onNodeWithTag("numberServings", useUnmergedTree = true).assertTextEquals("1")
    ...
    composeTestRule.onNodeWithTag("numberServings", useUnmergedTree = true).assertTextEquals("2")
  ...
  fun testIngredientsListCheckboxes() {
    ...
    composeTestRule
        .onAllNodesWithTag("checkboxIngredient", useUnmergedTree = true)[2]
        .performScrollTo()
  ...
  fun testIngredientQuantityIncreasedOnServingsChange() {
    ...
    // Check if ingredient list is displayed with checkboxes
    composeTestRule.onNodeWithTag("ingredientButton", useUnmergedTree = true).assertIsDisplayed()

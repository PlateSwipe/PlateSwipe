...
class SwipePageTest : TestCase() {
    ...
    private val mockedIngredient =
        testIngredients[0].copy(categories = listOf(mockedRecipesList[0].ingredientsAndMeasurements[0].first.lowercase()))
    ...
    fun setUp() = runTest {
        ...
        composeTestRule.setContent {
            SwipePage(
                mockNavigationActions, recipesViewModel, userViewModel
    ...
    fun recipeAndDescriptionAreCorrectlyDisplayed() = runTest {
        ...
        composeTestRule.onNodeWithTag(RECIPE_FRIDGE_INGREDIENTS, useUnmergedTree = true)
            .assertIsDisplayed()
        composeTestRule.onNodeWithTag(RECIPE_FRIDGE_INGREDIENTS_TEXT, useUnmergedTree = true)
            .assertIsDisplayed()
    ...
    fun shawRecipeButtonIsDisplayed() = runTest {
        composeTestRule.onNodeWithTag(VIEW_RECIPE_BUTTON, useUnmergedTree = true)
            .assertIsDisplayed()
    ...
    fun timeRangeChipDisplaysAndHidesCorrectly() {
        ...
        composeTestRule.onNodeWithTag(FILTER_ROW, useUnmergedTree = true)
        ...
        composeTestRule.onNodeWithTag("timeRangeChip$DELETE_SUFFIX", useUnmergedTree = true)
            .performClick()
    ...
    fun difficultyChipDisplaysAndHidesCorrectly() {
        ...
        // Click the close icon to hide the chip
        composeTestRule.onNodeWithTag("difficultyChip$DELETE_SUFFIX", useUnmergedTree = true)
            .performClick()
    ...
    fun categoryChipDisplaysAndHidesCorrectly() {
        ...
        // Click the close icon to hide the chip
        composeTestRule.onNodeWithTag("categoryChip$DELETE_SUFFIX", useUnmergedTree = true)
            .performClick()

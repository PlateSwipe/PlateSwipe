...
interface ImageRepository {
     ...
     */
    fun getImage(imageUID: String, imageType: ImageType, onSuccess: (ImageBitmap) -> Unit, onFailure: (Exception) -> Unit)
     ...
     * @param onFailure method that will be called when the retrieval has failed
     */
    fun uploadImageFromDevice(imageUID: String, imageType: ImageType, path : String, onSuccess: () -> Unit, onFailure: (Exception) -> Unit)

    /**
     * Method that uploads an image to the Firebase storage
     * @param imageUID uid of the image that corresponds to the uid of either the user, ingredient or recipe
     * @param imageType the type of image that we need to retrieve; see [ImageType] for more details
     * @param imageFileStream the file stream containing the image
     * @param onSuccess method that will be called when the retrieval is successful
     * @param onFailure method that will be called when the retrieval has failed
     */
    fun uploadImage(imageUID: String, imageType: ImageType, imageFileStream: FileInputStream, onSuccess: () -> Unit, onFailure: (Exception) -> Unit)
     ...
     * @param onFailure method that will be called when the retrieval has failed
     */
    fun deleteImage(imageUID: String, imageType: ImageType, onSuccess: () -> Unit, onFailure: (Exception) -> Unit)
}
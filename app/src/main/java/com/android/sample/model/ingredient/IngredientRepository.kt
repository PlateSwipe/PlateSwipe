...
interface IngredientRepository {
   ...
   * @param onFailure The callback to be called when the ingredient is not found or an error occurs
   *   when retrieving it.
   */
   ...
   * @param onFailure The callback to be called when the ingredients are not found or an error
   *   occurs when retrieving them.
